...
export default async function TelemetryIndex() {
  ...
  if (!articles || articles.length === 0) {
    return (
      <div className="min-h-screen pt-32 px-4 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="text-3xl font-serif text-white mb-4">Sin Señal de Telemetría</h1>
        <p className="font-mono text-sm text-[var(--color-mist-gray)]">No se han encontrado reportes en la bóveda de datos.</p>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <p className="max-w-2xl font-mono text-sm text-[var(--color-mist-gray)] leading-relaxed">
            Reportes de ingeniería, post-mortems de arquitectura y blueprints técnicos diseñados para CTOs y Product Engineers.
          </p>
        </div>
