          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <motion.div variants={itemVariants} className="flex flex-wrap gap-4 relative z-50 mt-10">
                ...
                <MagneticWrapper strength={20}>
                  <a href={`/cv/${content.cvName}`} download className="btn-outline cursor-none border-[var(--color-orbital-teal)]/30 hover:border-white text-[var(--color-mist-gray)] hover:text-white transition-colors bg-black/40 backdrop-blur-sm flex items-center gap-2">
